    ...
    <nav class="navbar navbar-expand bg-transparent border-none">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav position-absolute end-0">
            <li class="nav-item">
              <a class="nav-link active border-none px-3" aria-current="page" href="./placeOrder.php">Place Order</a>
            </li>
            <li class="nav-item">
              <a class="nav-link border-none px-3" href="#">My Orders</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link border-none px-3 text-warning" href="#">Logout</a>
            </li>
          </ul>
        </div>
    </nav>
