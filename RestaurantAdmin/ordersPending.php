<?php
  ...
  $sql = "SELECT distinct(order_id) FROM orders WHERE status='pending'";
...
<body>
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="./ordersPending.php">
            Pending
        ...
        <?php
            ...
            while($row = mysqli_fetch_array($result)){
              ...
              echo "<div class='block'>";
                ...
                echo "</div>";
                $order_id = $row[0];
                $statusToChange = "served";
                echo "<div class='button bg-danger' onclick=changeStatus(" .$order_id.",'".$statusToChange."',".$tableid.") >";
                  echo "Mark As Served";
                echo "</div>";
              echo "</div>";
