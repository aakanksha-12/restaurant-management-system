<?php
  ...
  $sql = "SELECT distinct(order_id) FROM orders WHERE status='served'";
...
<body>
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="./ordersServed.php">
            Served
        ...
        <li class="nav-item">
          <a class="nav-link" href="./ordersFinished.php">
            Finished
        ...
        <?php
            ...
            while($row = mysqli_fetch_array($result)){
              ...
              echo "<div class='block'>";
                ...
                echo "</div>";
                $order_id = $row[0];
                $statusToChange = "finished";
                echo "<div class='button bg-success' onclick=changeStatus(" .$order_id.",'".$statusToChange."',".$tableid.") >";
                  echo "Mark As Finished";
                echo "</div>";
              echo "</div>";
